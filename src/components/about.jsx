                ...
                <div className="about">
                    ...
                    <div className="cores py-2 mt-4">
                        <div className="tabs d-flex justify-content-center align-items-center py-2">
                            <li className="mx-3" onClick={() => setSectionNumber(1)}>Mission</li>
                            <li className="mx-3" onClick={() => setSectionNumber(2)}>Values</li>
                            <li className="mx-3" onClick={() => setSectionNumber(3)}>Vision</li>
                        </div>
                        {
                            sectionNumber === 1?
                            <div className="core">
