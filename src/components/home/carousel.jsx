            ...
            <div className="controllers d-flex align-items-center h-100">
                <span className="left">
                    <div className="counter d-flex justify-content-center">
                        <div className="count" onClick={() =>   setSlideNumber(0)}>
            ...
            <div className="container-fluid w-100 p-0">
                {
                        ...
                        <div className="slides" style={{backgroundImage:`url(${slide1})`}}> 
                            <div className="container-fluid d-flex justify-content-center h-100 w-100">
                                <div className="header-content">
                                    <h3 className="py-2">Welcome To classic Fumigation</h3>
                    ...
                    : slideNumber === 1 ?
                        <div className="slides" style={{backgroundImage:`url(${slide2})`}}>
                            <div className="container-fluid d-flex justify-content-center h-100 w-100">
                                <div className="header-content">
                                    <h4 className="py-2">As a leading force in professional fumigation services,<br /> we take pride in safeguarding homes and <br /> businesses with unmatched expertise, cutting-edge technology, <br />and a commitment to excellence.</h4>\
                        ...
                        <div className="slides" style={{backgroundImage:`url(${slide3})`}}>
                            <div className="container-fluid d-flex justify-content-center h-100 w-100">
                                <div className="header-content" style={{marginLeft:'10%'}}>
                                    <h4 className="py-2">We don't just eliminate pests;<br /> we create environments that foster health, comfort, and tranquility.<br /> Join us in the pursuit of pest-free living because your well-being matters.</h4>
                                </div>
                            </div>
                        </div> 
                    :<></>
