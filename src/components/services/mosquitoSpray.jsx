...
export default function MosquitoSpray() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
                        ...
                        <div className="taskbar-link-list">
                            ...
                            <ul className="taskbar-list">
                                {Services.map((service) => (
                                    <li className={`taskbar-links${service.id === 6 ? "-active" : ""}`} key={service.id}><Link to={`/services/${service.link}`}>{service.title}</Link></li>
                                ))}
                            </ul>
                        </div>
